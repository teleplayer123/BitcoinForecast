...
X_train, X_test, y_train, y_test = preprocess_data(scaled_data, SEQ_LEN, 0.01)
print(X_train.shape)
print(y_train.shape)
print(X_test.shape)
print(y_test.shape)
...
model = build_n_layer_model(128, 5, input_shape=(X_train.shape[1:]))
model.summary()
